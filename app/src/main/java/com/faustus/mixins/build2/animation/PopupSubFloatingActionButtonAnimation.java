 ...
 */
public class PopupSubFloatingActionButtonAnimation extends MenuAnimationHandler {
    ...
    public PopupSubFloatingActionButtonAnimation() {
        setAnimating(false);
    }
    ...
    public void animateMenuOpening(Point center) {
        ...
        for (int i = 0; i < menu.getSubActionItems().size(); i++) {
            ...
            final ObjectAnimator animation = ObjectAnimator.ofPropertyValuesHolder(menu.getSubActionItems().get(i).view, pvhX,pvhY,pvhsX, pvhsY, pvhA);
